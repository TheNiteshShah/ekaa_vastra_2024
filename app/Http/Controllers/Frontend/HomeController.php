...
class HomeController extends Controller
{
    ...
    public function index(Request $req)
    {
        ...
        $title = "Ekaa Vastra | Elegant Women's Clothing – Kurta Sets, Co-ord Sets, Tops & More";
        $seo_description = "Explore Ekaa Vastra's exquisite collection of women's clothing, including kurta sets, kurtas, co-ord sets, tops, pants, and 3-piece suit sets. Discover stylish, comfortable, and high-quality ethnic wear for every occasion.";
