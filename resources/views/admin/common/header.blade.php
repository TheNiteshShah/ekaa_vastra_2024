            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    <!-- <form role="search" class="app-search">
                        <div class="form-group mb-0">
                            <input type="text" id="searchInput" class="form_control" placeholder="Search.." style="margin: 0px 5px;width:auto;color:#70767b;background:none;border: 1px solid #70767b;">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        // print_r($ser); die();
                        if ($ser[0] == "999") {
                            $admin_sidebar = App\Models\AdminSidebar::OrderBy('seq', 'asc')->get();
                            // print_r($admin); die();
                        ...
                        ?>
                                    <?php if ($sidebar->url == "#") { ?>
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                <?php
                                                $admin_sidebar2 = App\Models\AdminSidebar2::where('main_id', $sidebar->id)->get();
                                                // print_r($admin); die();
                            ...
                            <?php } else {
                            foreach ($ser as $s) {
                                $sidebar = App\Models\AdminSidebar::where('id', $s)->first();
                                // print_r($admin); die();
                                if (!empty($sidebar)) {
                            ?>
                                    <?php if ($sidebar->url == "#") { ?>
