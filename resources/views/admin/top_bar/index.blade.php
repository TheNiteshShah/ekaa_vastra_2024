                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2"> <a class="btn btn-info cticket" href="{{route('top_bar.create')}}" role="button" style="margin-left: 20px;"> Add {{$title}}</a></div>
                                @endif
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" id="btns{{$loop->iteration}}">
                                                        @if($data->is_active == 0)
                                                        <a href="{{route('top_bar.show',base64_encode($data->id))}}"><i class="fas fa-check success-icon" data-toggle="tooltip" data-placement="top" title="Active"></i></a>
                                                        @else
                                                        <a href="{{route('top_bar.show',base64_encode($data->id))}}"><i class="fas fa-times danger-icon" data-toggle="tooltip" data-placement="top" title="Inactive"></i></a>
                                                        @endif
                                                        <a href="{{route('top_bar.edit',base64_encode($data->id))}}"><i class="fas fa-pencil-alt info-icon" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                                    ...
                                                    <div style="display:none" id="cnfbox{{$loop->iteration}}">
                                                        ...
                                                        <form method="post" action="{{ route('top_bar.destroy', base64_encode($data->id)) }}" style="display:inline">
                                                            @csrf
                                                            @method('DELETE')
