        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('top_bar.index')}}">Back</a></li>
                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form action="{{route('top_bar.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{$data->id}}">
                                <div class="form-group row">
                                    <div class="col-sm-12 my-3" style="margin-top: 23px!important">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('content') is-invalid @enderror" value="{{old('content') ? old('name') : $data->content}}" id="content" name="content" placeholder="Enter Content" required>
                                            <label for="content">Enter Content &nbsp;<span style="color:red;">*</span></label>
                                        </div>
                                        @error('content')
