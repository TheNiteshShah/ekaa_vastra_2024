        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('testimonial.index')}}">Back</a></li>
                            ...
                            <form action="{{route('testimonial.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 my-3" style="margin-top: 23px!important">
                                        <label for="review">Enter Review &nbsp;<span style="color:red;">*</span></label>
                                        <textarea class="form-control" type="text" rows="4" cols="50" class="form-control @error('review') is-invalid @enderror"  name="review" required>{{old('review') ? old('review') : $data->review}}</textarea>
