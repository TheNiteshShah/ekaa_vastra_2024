                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2"> <a class="btn btn-info cticket" href="{{route('testimonial.create')}}" role="button" style="margin-left: 20px;"> Add {{$title}}</a></div>
                                @endif
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" id="btns{{$loop->iteration}}">
                                                        <a href="{{route('testimonial.edit',base64_encode($data->id))}}"><i class="fas fa-pencil-alt info-icon" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                                    ...
                                                    <div style="display:none" id="cnfbox{{$loop->iteration}}">
                                                        ...
                                                        <form method="post" action="{{ route('testimonial.destroy', base64_encode($data->id)) }}" style="display:inline">
                                                            @csrf
                                                            @method('DELETE')
