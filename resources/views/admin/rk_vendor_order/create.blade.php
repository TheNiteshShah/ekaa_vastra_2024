                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('rk-vendor-order.store') }}" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3 my-3">
                                        <label class="d-block">HSN Code</label>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input"
                                                ...
                                                id="hsn_code_yes"
                                                value="1"
                                                {{ old('hsn_code', $data->hsn_code ?? 1) == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="hsn_code_yes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input"
                                                type="radio"
                                                ...
                                                id="hsn_code_no"
                                                value="0"
                                                {{ old('hsn_code', $data->hsn_code ?? 1) == 0 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="hsn_code_no">No</label>
                                        </div>
                                        @error('hsn_code')
                                        <div style="color:red">{{ $message }}</div>
                                        @enderror
