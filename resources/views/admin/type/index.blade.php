                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2"> <a class="btn btn-info cticket" href="{{route('types.create',$product_id)}}" role="button" style="margin-left: 20px;"> Add {{$title}}</a></div>
                                @endif
                            </div>
                                    ...
                                    <table id="userTable" class="table  table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @if ($data->{"attribute" . $index} == $masterAttribute->id)
                                                <th>{{$masterAttribute->name}}</th>
                                                @endif
                                                @endforeach
                                                @endforeach
                                                ...
                                                <td>
                                                    <div class="btn-group" id="btns{{$loop->iteration}}">
                                                        @if($data->is_active == 0)
                                                        <a href="{{route('types.show',base64_encode($data->id))}}"><i class="fas fa-check success-icon" data-toggle="tooltip" data-placement="top" title="Active"></i></a>
                                                        @else
                                                    ...
                                                    <div style="display:none" id="cnfbox{{$loop->iteration}}">
                                                        ...
                                                        <form method="post" action="{{ route('types.destroy', base64_encode($data->id)) }}" style="display:inline">
                                                            @csrf
                                                            @method('DELETE')
