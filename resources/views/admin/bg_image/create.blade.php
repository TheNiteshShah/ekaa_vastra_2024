        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('bg_image.index')}}">Back</a></li>
                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form action="{{route('bg_image.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 my-3">
                                        <label for="web_image">Web Image &nbsp;<span style="color:red;"></span></label>
                                        <input type="file" class="form-control" type="text" value="" id="web_image" name="web_image" placeholder="Enter Web Image">
                                        @if($data->web_image)
                                        <img id="slide_img_path2" height=100 width=100 src="{{asset($data->web_image)}} ">
                                        @endif
                                        @error('web_image')
                                        <div style="color:red">{{$message}}</div>
                                        @enderror
                                    ...
                                    <div class="col-sm-6 my-3">
                                        <label for="mob_image">Mob Image &nbsp;<span style="color:red;"></span></label>
                                        <input type="file" class="form-control" type="text" value="" id="mob_image" name="mob_image" placeholder="Enter Image">
                                        @if($data->mob_image)
                                        <img id="slide_img_path2" height=100 width=100 src="{{asset($data->mob_image)}} ">
                                        @endif
                                        @error('mob_image')
                                        <div style="color:red">{{$message}}</div>
                                        @enderror
