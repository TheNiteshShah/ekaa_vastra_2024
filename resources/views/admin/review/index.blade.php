        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('products.index',base64_encode($parentData->minorcategory_id))}}">Back</a></li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" id="btns{{$loop->iteration}}">
                                                        @if($data->is_active == 0)
                                                        <a href="{{route('review.show',base64_encode($data->id))}}"><i class="fas fa-check success-icon" data-toggle="tooltip" data-placement="top" title="Active"></i></a>
                                                        @else
                                                        <a href="{{route('review.show',base64_encode($data->id))}}"><i class="fas fa-times danger-icon" data-toggle="tooltip" data-placement="top" title="Inactive"></i></a>
                                                        @endif
                                                    ...
                                                    <div style="display:none" id="cnfbox{{$loop->iteration}}">
                                                        ...
                                                        <form method="post" action="{{ route('review.destroy', base64_encode($data->id)) }}" style="display:inline">
                                                            @csrf
                                                            @method('DELETE')
