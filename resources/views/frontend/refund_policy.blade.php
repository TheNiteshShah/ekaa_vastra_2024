...
<section class="whish-list-section theme1 pb-70">
    <div class="container grid-wraper">
        <h5 class="title mb-20">Return, Refund, and Exchange Policy</h5>
        <p class="mb-20 text-justify">Thank you for choosing Ekaa Vastra for your shopping needs. We are dedicated to providing you with a seamless experience and ensuring your satisfaction with every purchase. Please review our Return, Refund, and Exchange Policy below to understand your options regarding your purchases.</p>
        <h5 class="title mb-20">Return Policy:</h5>
