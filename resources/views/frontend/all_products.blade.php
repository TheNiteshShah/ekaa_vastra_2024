...
@section('main')
    ...
    <div class="product-tab">
        <div class="container-custom grid-wraper">
            <div class="row">
                                    ...
                                    <ul class="nav nav-pills align-items-center">
                                        <li>
                                            <span class="total-products text-capitalize">
                                                Showing {{ count($productData) }}
                                                {{ count($productData) === 1 ? 'product' : 'products' }} available.
                                            </span>
                                        </li>
                                ...
                                <div class="shop-grid-button d-flex align-items-center">
                                    ...
                                    <div class="dropdown-menu shop-grid-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ request()->fullUrlWithQuery(['sort' => 'low_to_high']) }}">Price, low
                                            to high</a>
                                        <a class="dropdown-item"
                                            href="{{ request()->fullUrlWithQuery(['sort' => 'high_to_low']) }}">Price, high
                                            to low</a>
                                    </div>
                                        ...
                                        <div class="media flex-column">
                                            <div class="product-thumbnail w-100 position-relative">
                                                ...
                                                <a class="d-block" href="{{ route('product', $product->slug) }}">
                                                    <img class="first-img" style="z-index:1" loading="lazy"
                                                        src="{{ asset($product->image) }}" alt="thumbnail">
                                                    <img class="second-img" style="z-index:1" loading="lazy"
                                                        src="{{ asset($product->image2 ? $product->image2 : $product->image1) }}"
                                                        alt="thumbnail">
                                                </a>
                                                @if (auth()->check())
                                                    @php
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        onclick="toggleWishlist({{ $product->id }}, this)"><span
                                                            class="hear-icon top-right product{{ $product->id }}"> <i
                                            ...
                                            <div class="media-body">
                                                <div class="product-desc">
                                                    ...
                                                    <p class="product-price">
                                                        <span
                                                            class="onsale">₹{{ number_format($product->selling_price) }}</span>
                ...
                <div class="col-lg-3 mb-10 order-lg-first filter---box">
                    <aside class="left-sidebar theme1">
                        <div class="search-filter border-top mt-60 pt-45">
                            <form action="#">
    ...
    @if (!$relatedData->isEmpty())
        ...
        <section class="theme1 bg-white pb-50">
            <div class="container-custom">
                <div class="row">
                    <div class="col-12">
        ...
        <div class="row text-center">
            <div class="col-6 p-2">
                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"> <img
                        src="{{ asset('frontend/img/icon/filter.png') }}" loading="lazy"> FILTER</a>
            </div>
            <div class="col-6 p-2" style="border-right: 2px solid #dee2e6 ;">
                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal2"> <img
                        src="{{ asset('frontend/img/icon/sort.png') }}" loading="lazy"> SORT BY </a>
            </div>
        </div>
    </div>
                        ...
                        <div class="popup_content">
                            ...
                            <ul style="list-style-type: none; text-align: center; padding: 0; margin: 0;">
                                <li style="padding: 15px 0; border-bottom: 2px solid rgb(235, 232, 232);">
                                    <a href="javascript:;" onclick="sortBy('low_to_high')" id="sort_low_to_high"
                                        class="{{ request('sort') == 'low_to_high' ? 'active-sort' : '' }}">
                                        Sort by price: Low to High
                                    </a>
                                </li>
                                <li style="padding: 15px 0; border-bottom: 2px solid rgb(235, 232, 232);">
                                    <a href="javascript:;" onclick="sortBy('high_to_low')" id="sort_high_to_low"
                                        class="{{ request('sort') == 'high_to_low' ? 'active-sort' : '' }}">
