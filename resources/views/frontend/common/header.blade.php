...
<head>
    ...
    <meta name="description"
        content="{{ !empty($seo_description) ? $seo_description : 'Explore premium women\'s clothing including kurta sets, co-ord sets, and more at Ekaa Vastra.' }}">
    <meta name="keywords"
        content="{{ !empty($seo_keywords) ? $seo_keywords : 'women clothing, kurta sets, co-ord sets, fashion, Ekaa Vastra' }}">
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=2366447247032597&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
    <!-- Google Tag Manager -->
    <script>
        (function(w, d, s, l, i) {
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KZ4GPFRC" height="0" width="0"
    ...
    <div id="offcanvas-mobile-menu" class="offcanvas theme1 offcanvas-mobile-menu">
        <div class="inner">
            ...
            <div class="offcanvas-head mb-4">
                <nav class="offcanvas-top-nav">
                    <ul class="d-flex justify-content-center align-items-center">
                        @if (auth()->check())
                            <li class="mx-3 btn theme-btn--dark3 btn-md"><a href="{{ route('my-account') }}">My
                                    Account</a></li>
                        @endif
                        <li class="mx-3">
                            @if (auth()->check())
                                ...
                                <form method="POST" id="logout-form" action="">
                                    @csrf
                                    <button type="button" class="btn theme-btn--dark3 btn-md d-none d-md-inline"
                                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                        Logout
                                    </button>
                                    <a href="javascript:void(0)"
                                        class="btn theme-btn--dark3 btn-md btn-sm d-inline d-md-none"
                                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                        Logout
                            ...
                            @else
                                ...
                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#login"
                                    class="btn theme-btn--dark3 btn-md">
                            ...
                            <li><a href="javascript:void(0)"><span class="menu-text">{{ $category->name }}</span></a>
                                <ul class="offcanvas-submenu">
                                    @foreach ($category->SubCategory as $subcategory)
                                        <li><a
                                                href="{{ route('collection', $subcategory->slug) }}">{{ $subcategory->name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </li>
            ...
            <div class="offcanvas-social py-30">
                <ul>
                    <li>
                        <a target="_blank" rel="noopener" href="https://www.facebook.com/ekaavastra"><i
                                class="icon-social-facebook"></i></a>
                    </li>
                    <li>
                        <a target="_blank" rel="noopener" href="https://www.instagram.com/ekaavastra/"><i
        ...
        <div class="inner">
            ...
            @if (!empty($wishlistItems) && $wishlistItems != '[]')
                <ul class="minicart-product-list">
                    @foreach ($wishlistItems as $wish)
                        <li>
                            <a href="{{ route('product', $wish->product->slug) }}" class="image"><img
                                    src="{{ asset($wish->product->image) }}" loading="lazy"
                                    alt="Cart product Image"></a>
                            <div class="content">
                                <a href="{{ route('product', $wish->product->slug) }}"
                                    class="title">{{ $wish->product->name }}</a>
                                <h6 class="product-price"><del class="del"
                                        style="font-size: 13px;">₹{{ $wish->product->mrp }}</del>
                                    <span class="onsale"
                                        style="font-size: 13px;">₹{{ $wish->product->selling_price }}</span>
                                </h6>
                                <button class="btn theme-btn--dark3 btn--sm mt-10" data-bs-toggle="modal"
                                    data-bs-target="#wishSizeModal" data-product-id="{{ $wish->product->id }}"
                                    data-type-id="" data-qty="1">
            ...
            @else
                <div class="text-center ">
                    <img src="{{ asset('frontend/img/empty_wishlist.jpg') }}" loading="lazy" alt="Empty-Wishlist"
        ...
        <div class="inner">
            ...
            @if (!empty($cartItems) && $cartItems != '[]')
                <ul class="minicart-product-list">
                    ...
                    @foreach ($cartItems as $cart)
                        @if (!auth()->check())
                            ...
                            @endphp
                            <li>
                                <a href="{{ route('product', $type->product->slug) }}" class="image"><img
                                        src="{{ asset($type->product->image) }}" loading="lazy"
                                        alt="Cart product Image"></a>
                                <div class="content">
                                    <a href="{{ route('product', $type->product->slug) }}"
                                        class="title">{{ $type->product->name }}</a>
                                    <span class="quantity-price mt-0"><b>Size:</b> {{ $type->size->name }}</span>
                                    <span class="quantity-price mt-0">{{ $cart['quantity'] }} x <span
                                            class="amount">₹{{ $type->product->selling_price }}</span></span>
                        ...
                        @else
                            ...
                            @endphp
                            <li>
                                <a href="{{ route('product', $cart->product->slug) }}" class="image"><img
                                        src="{{ asset($cart->product->image) }}" loading="lazy"
                                        alt="Cart product Image"></a>
                                <div class="content">
                                    <a href="{{ route('product', $cart->product->slug) }}"
                                        class="title">{{ $cart->product->name }}</a>
                                    <span class="quantity-price mt-0"><b>Size:</b>
                                        {{ $cart->type->size->name }}</span>
                                    <span class="quantity-price mt-0">{{ $cart->quantity }} x <span
                                            class="amount">₹{{ $cart->product->selling_price }}</span></span>
                                    <!-- <a href="javascript:void(0)" class="remove">×</a> -->
                                </div>
                            </li>
                        @endif
                ...
                <div class="d-md-flex d-lg-flex d-xl-flex justify-content-center">
                    <a href="{{ route('cart') }}"
                        class="btn theme--btn1 btn--cm text-uppercase  d-block d-sm-inline-block me-sm-2">view
                        Bag</a>
                    @if (auth()->check())
                        <a href="{{ route('checkout') }}"
                            class="btn theme--btn1 btn--cm text-uppercase  d-block d-sm-inline-block mt-4 mt-sm-0">checkout</a>
                    @else
                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#login"
                            class="btn theme--btn1 btn--cm text-uppercase  d-block d-sm-inline-block mt-4 mt-sm-0">checkout</a>
                    @endif
            ...
            @else
                <div class="text-center ">
                    <img src="{{ asset('frontend/img/empty_bag.jpg') }}" loading="lazy" alt="Empty-Bag"
                        class="img-fluid" style="width:50%">
                </div>
                ...
                <div class="modal-header">
                    <div class="row">
                        <div class="col-md-11 col-10 text-center">
                            <img src="{{ asset('frontend/img/logo.svg') }}" alt="logo" style="width:30%"
                                class="img-fluid">
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <form class="log-in-form" id="login-form">
                        <div class="form-group row">
                            <label for="loginEmail" class="col-md-2 col-2 col-form-label"
                                style="text-align:end">Email</label>
                        ...
                        <div class="sign-btn text-center mt-3">
                            <button type="submit" id="sendOtpButton"
                                class="btn theme-btn--dark1 btn--md w-100">Login with OTP</button>
                            <button class="btn theme-btn--dark1 btn--md w-100 d-none" id="login-loader"
                                style="border-color:#09080A;;" type="button" disabled>
                                <span style="color:#09080A;">Loading...</span>
                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"
                                    style="color:#09080A;"></span>
                            </button>
                        </div>
                    </form>
                ...
                <div class="modal-header">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <img src="{{ asset('frontend/img/logo.svg') }}" loading="lazy" alt="logo"
                    ...
                    <form class="sign-up-form" id="signup-form" action="{{ route('user-signup') }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12 mt-2">
                                <input type="text" onkeypress="return isNumberKey(event)" maxlength="10"
                                    minlength="10" class="form-control" id="signupPhone" name="signupPhone"
                                    placeholder="Mobile Number +91" required>
                                <div class="col-md-10 col-10">
                                </div>
                            </div>
                        </div>
                        <div id="recaptcha-container"></div>
                        <div class="sign-btn text-center mt-3">
                            <button type="submit" id="signUpButton" class="btn theme-btn--dark1 btn--md w-100">Sign
                                Up</button>
                            <button class="btn theme-btn--dark1 btn--md w-100 d-none" id="login-loader"
                                style="border-color:#09080A;" type="button" disabled>
                                <span style="color:#09080A;">Loading...</span>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="border:none">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center pb-30">Enter the 6-digit verification code that was sent to your email
                        address.</p>
                    <form class="otp-form" id="otp-form">
                        ...
                        <button class="btn theme-btn--dark1 btn--md w-100 d-none" id="otp-loader"
                            style="border-color:#09080A;" type="button" disabled>
                            <span style="color:#09080A;">Loading...</span>
                            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"
                                style="color:#09080A;"></span>
                        ...
                        <div class="resend pt-30 text-center pb-30">
                            <button id="resendOtpButton" class="btn btn-link" style="color:#292929" disabled>Resend
                                OTP in <span id="timer">30</span>s</button>
                        </div>
                    </form>
                </div>
    ...
    <header id="sticky" class="header2 style1 theme1"
        style="position: sticky; top: 0; left: 0; width: 100%; background: #ffffff; z-index: 999;">
        <!-- top bar start -->
        @if (!empty($topBarData))
            ...
            <div class="container">
                <div class="row align-items-center position-relative">
                    <div class="col-6 col-lg-2 col-xl-3 order-first">
                        <div class="logo ">
                            <a href="{{ route('/') }}">
                                <img src="{{ asset('frontend/img/logo.svg') }}" loading="lazy"
                                    alt="Ekaa Vastra - Women's Clothing" style="width:45%" class="img-fluid ">
                            </a>
                        </div>
                    </div>
                        ...
                        <nav class="header-bottom theme1">
                            <ul class="main-menu d-flex align-items-center">
                                @foreach ($categoryData as $category)
                                    <li>
                                        @if ($category->SubCategory->count() > 0)
                                            <a href="javascript:void(0)">{{ $category->name }} <i
                                        ...
                                        @else
                                            <a
                                                href="{{ route('collection', $category->slug) }}">{{ $category->name }}</a>
                                        @endif
                                    </li>
                                @endforeach
                                <li><a href="{{ route('about-us') }}" title="Learn about Ekaa Vastra">About Us</a>
                                </li>
                                <li><a href="{{ route('contact-us') }}">Contact Us</a></li>
                                <!-- <li>
                            ...
                            <div class="cart-block-links theme1">
                                <ul class="side-menu d-flex align-items-center">
                                    ...
                                    <li class="me-0 cart-block position-relative d-none d-sm-block">
                                        @if (auth()->check())
                                            <a href="javascript:void(0)" title="User Account"><i
                                                    class="icon-user"></i> <i class="ion-ios-arrow-down"></i></a>
                                            <ul class="sub-menu side-ul">
                                                <li><a href="{{ route('my-account') }}" title="My Account">My
                                                        Account</a></li>
                                                <li>
                                        ...
                                        @else
                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                data-bs-target="#login" title="Login">
                                                <i class="icon-user"></i>
                                            </a>
                                        @endif
                                    </li>
