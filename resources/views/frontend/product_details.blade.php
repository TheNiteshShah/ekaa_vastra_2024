            ...
            <div class="content_setting">
                <div class="info_setting">
                    <div class="mb-30 border-bottom pb-30 border-bottom">
                        ...
                        <img src="{{ asset($productData->size_chart) }}" loading="lazy" alt="Size Chart"
                            class="img-fluid d-block mx-auto">
                        <p class="mt-2"><b>Note -</b> These are Garment sizes, take your body measurements and match the
                            garment accordingly.</p>
                    </div>
                    <div>
                        <h2 class="title_setting ">Garment Measuring Guide</h2>
                        <img src="{{ asset('frontend/img/garment-guide.jpg') }}" loading="lazy" alt="Garment-Guide"
                            class="img-fluid d-block mx-auto">
                    </div>
                ...
                <div class="col-12">
                    <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center ">
                        ...
                        <li class="breadcrumb-item">
                            <a
                                href="{{ route('collection', $productData->subcategory ? $productData->subcategory->slug : $productData->category->slug) }}">{{ $productData->subcategory ? $productData->subcategory->name : $productData->category->name }}</a>
                        </li>
                ...
                <div class="col-md-9 mx-auto col-lg-7 mb-5 mb-lg-0">
                    ...
                    <div class="product-sync-nav slick-nav-sync">
                        @if ($productData->image)
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"> <img src="{{ asset($productData->image) }}"
                                            loading="lazy" alt="product-thumb"></a>
                                </div>
                            </div>
                            <!-- single-product end -->
                        @endif
                        @if ($productData->image2)
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"> <img src="{{ asset($productData->image2) }}"
                                            loading="lazy" alt="product-thumb"></a>
                                </div>
                            </div>
                            <!-- single-product end -->
                        ...
                        @if ($productData->image3)
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"> <img src="{{ asset($productData->image3) }}"
                                            loading="lazy" alt="product-thumb"></a>
                                </div>
                            </div>
                            <!-- single-product end -->
                        ...
                        @if ($productData->image4)
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"> <img src="{{ asset($productData->image4) }}"
                                            loading="lazy" alt="product-thumb"></a>
                                </div>
                            </div>
                            <!-- single-product end -->
    ...
    @endif -->
                                @if (auth()->check())
                                    ...
                                    <a href="javascript:void(0)"
                                        onclick="toggleWishlist({{ $productData->id }}, this)"><span
                                            class="hear-icon2 top-right product{{ $productData->id }}"> <i
                                                class="{{ $isInWishlist ? 'ion-ios-heart' : 'ion-ios-heart-outline' }}"></i></span></a>
                                @endif
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-10 border-bottom pb-10">
                                <p class="product-price">
                                    ...
                                    @if ($percentageSaved > 0)
                                        <span class="product-discountPercentage">({{ number_format($percentageSaved) }}%
                                            Off)</span>
                                    @endif
                                </p>
                            </div>
                        ...
                        <div class="product-footer">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a class="offcanvas-toggle" href="#offcanvas-size-chart"
                                    style="font-weight: 400; color: black; font-size: 14px; text-decoration: none;">
                            ...
                            <nav class="shop-grid-nav mt-10">
                                <ul class="product-tag d-flex flex-wrap">
                                    @foreach ($productData->types as $index => $type)
                                        <li><a href="javascript:void(0)" value="{{ $type->id }}"
                                                class="{{ $type->inventory == 0 ? 'out' : '' }}"
                                                onclick="updateTypeId(this, {{ $type->id }})">{{ $type->size->name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="product-count style d-flex flex-column flex-sm-row mt-30 mb-30">
                                <div class="count d-flex">
                                    ...
                                    <input type="number" min="1" max="10" step="1" value="1"
                                        name="quantity" id="quantity" aria-labelledby="quantity" />

                                    <div class="button-group">
                                        <!-- Increase button with aria-label -->
                                        <button class="count-btn increment" aria-label="Increase quantity"
                                            aria-controls="quantity" aria-describedby="quantity">
                                            <i class="fas fa-chevron-up"></i>
                                        </button>

                                        <!-- Decrease button with aria-label -->
                                        <button class="count-btn decrement" aria-label="Decrease quantity"
                                            aria-controls="quantity" aria-describedby="quantity">
                                ...
                                <div>
                                    @if ($cartInfo)
                                        <a href="{{ route('cart') }}"><button id="go-to-cart-btn"
                                                class="btn theme-btn--dark1 btn--xl mt-30 mt-sm-0">
                                    ...
                                    @else
                                        ...
                                        <button class="btn theme-btn--dark3 btn--xl mt-30 mt-sm-0" id="add-cart-loader"
                                            style="border-color:#09080A;padding: 17px 40px;display:none;" type="button"
                                            disabled>
                                            <span style="color:#09080A;">Adding...</span>
                                            <span class="spinner-border spinner-border-sm" role="status"
                                                aria-hidden="true" style="color:#09080A;"></span>
                                        </button>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="pro-social-links mt-30">
                            <ul class="d-flex align-items-center">
                                ...
                                <li>
                                    <!-- WhatsApp Share -->
                                    <a href="https://api.whatsapp.com/send?text={{ route('product', $productData->slug) }}"
                                ...
                                <li>
                                    <!-- Facebook Share -->
                                    <a href="https://www.facebook.com/sharer.php?u={{ route('product', $productData->slug) }}"
                                        target="_blank" rel="noopener noreferrer">
                                ...
                                <li>
                                    <!-- Pinterest Share -->
                                    <a href="https://pinterest.com/pin/create/button/?url={{ route('product', $productData->slug) }}"
                                        target="_blank" rel="noopener noreferrer">
                        ...
                        <ul id="offcanvas-menu2" class="blog-ctry-menu">
                            ...
                            <li><a href="javascript:void(0)">Shipping Information </a>
                                <ul class="category-sub-menu">
                                    ...
                                    <li class="mb-0"><strong>Shipping Partner:</strong> Trusted carriers for safe
                                        delivery.</li>
                                    <li class="mb-0"><strong>Processing Time:</strong> Ships within <span>5-7 business
                                            days</span>.</li>
                                    <li class="mb-0"><strong>Delivery Time:</strong> Estimated arrival in <span>7-9
                                            business days</span>.</li>
                                    <li class="mb-0"><strong>Delivery Coverage:</strong> Available across India.</li>
                                    <li class="mb-0"><strong>Order Tracking:</strong> Tracking link provided via
                                        email/SMS.</li>
                                    <li class="mb-0"><strong>Possible Delays:</strong> Weather & logistics may affect
                                        timelines.</li>
                                    <li class="mb-0"><strong>Address Accuracy:</strong> Ensure correct details for smooth
                                        delivery.</li>
                                    <li class="mb-0"><strong>Need Help?</strong> Contact our <a
                                            href="{{ route('contact-us') }}"
                                            style="display: inline;padding: 0;line-height: 0;text-transform: lowercase;">support
                                            team</a>.</li>
                                </ul>
                            </li>
                            <li><a href="javascript:void(0)">Return & Exchange </a>
                                <ul class="category-sub-menu">
                                    <li class="mb-0">Defective items can be returned within <strong>48 hours</strong> for
                                        a refund.</li>
                                    <li class="mb-0">Non-defective returns allowed within <strong>7 days</strong> (store
                                        credit only, return shipping applies).</li>
                                    <li class="mb-0">Size exchange available within <strong>7 days</strong> (subject to
                                        stock).</li>
                                    <li class="mb-0"><strong>Cancellation:</strong> Orders can be canceled <strong>before
                                            dispatch</strong>. Prepaid refunds take <strong>3-5 business days</strong>.</li>
                                    <li class="mb-0"><strong>Need Help?</strong> Email us at <a
                                            href="mailto:ekaavastra@gmail.com"
                                            style="display: inline;padding: 0;line-height: 0;text-transform: lowercase;">ekaavastra@gmail.com</a>.
                                    </li>
