        ...
        <div class="main-slider dots-style theme1">
            @foreach ($sliderData as $index => $slider)
                ...
                <picture>
                    ...
                    <source srcset="{{ asset($slider->mob_image) }}" media="(max-width: 768px)" type="image/webp"
                        {{ $index === 0 ? 'fetchpriority=high' : '' }}>
                    <!-- Fallback image with proper alt text -->
                    <img src="{{ asset($slider->web_image) }}"
                        alt="{{ $slider->alt_text ?? 'Image showcasing our latest collection' }}"
                        {{ $index === 0 ? 'fetchpriority=high' : '' }}
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="section-title text-center mb-30">
                            ...
                            <p class="text">Explore our latest collection of women's ethnic wear, including kurtas, co-ord
                                sets, and suit sets.</p>
                        </div>
                    </div>
                                                    ...
                                                    <div class="product-thumbnail w-100 position-relative">
                                                        ...
                                                        <a class="d-block" href="{{ route('product', $trend->slug) }}"
                                                            ...
                                                            <img class="first-img" loading="lazy"
                                                                src="{{ asset($trend->image) }}" alt="{{ $trend->name }}"
                                                                itemprop="image">
                ...
                <div class="col-12">
                    <div class="position-relative overflow-hidden d-flex justify-content-center align-items-center">
                        <div class="banner-thumb banner-large">
                            ...
                            <picture>
                                <!-- Source for mobile -->
                                <source srcset="{{ asset($bannerData[0]->mob_image) }}" loading="lazy"
                                    media="(max-width: 768px)"
                                    alt="{{ $bannerData[0]->alt_text ?? 'Ekaa Vastra Banner' }}">
                                <!-- Source for desktop -->
                                <img src="{{ asset($bannerData[0]->web_image) }}" loading="lazy"
                                    alt="{{ $bannerData[0]->alt_text ?? 'Ekaa Vastra Banner' }}"
                ...
                <div class="col-12">
                    <div class="position-relative overflow-hidden d-flex justify-content-center align-items-center">
                        <div class="banner-thumb banner-large">
                            ...
                            <picture>
                                <!-- Source for mobile -->
                                <source srcset="{{ asset($bannerData[1]->mob_image) }}" loading="lazy"
                                    media="(max-width: 768px)"
                                    alt="{{ $bannerData[1]->alt_text ?? 'Ekaa Vastra Banner' }}">
                                <!-- Source for desktop -->
                                <img src="{{ asset($bannerData[1]->web_image) }}" loading="lazy"
                                    alt="{{ $bannerData[1]->alt_text ?? 'Ekaa Vastra Banner' }}"
                                    style="object-fit: cover; width: 100%; height: auto; display: block;">
                            </picture>
                            @if (!empty($bannerData[0]->link))
                                    ...
                                    <div class="testimonial-content text-center">
                                        ...
                                        <figure class="d-inline-block mb-30 mx-auto">
                                            <img loading="lazy"
                                                ...
                                                alt="{{ $test->name }}'s Testimonial" itemprop="image">
                                        </figure>
                                        ...
                                        <!-- Reviewer Name -->
                                        <footer>
                                            <h5 class="text-uppercase mb-15 mt-10" itemprop="author" itemscope
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-2 col-sm-6 col-6 mb-30">
                    <div class="d-flex static-media2 flex-column">
                        <img class="align-self-center mb-20" style="width: 30%;"
                            src="{{ asset('frontend/img/icon/free-shipping.png') }}" alt="Free shipping on all orders"
                            title="Free Shipping on All Orders">
                        <div class="media-body text-center">
                            <h4 class="title text-uppercase text-dark mb-25">
                                <a href="/shipping-policy" title="Learn more about our free shipping offer">Free
                                    Shipping*</a>
                            </h4>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6 col-6 mb-30">
                    <div class="d-flex static-media2 flex-column">
                        <img class="align-self-center mb-20" style="width: 30%;"
                            src="{{ asset('frontend/img/icon/india.png') }}" alt="Shipping available across India"
                            title="Shipping Available Across India">
                        <div class="media-body text-center">
                            <h4 class="title text-uppercase text-dark mb-25">
                                <a href="/shipping-info" title="Learn more about pan-India shipping">Shipping
                                    Pan-India</a>
                            </h4>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6 col-6 mb-30">
                    <div class="d-flex static-media2 flex-column">
                        <img class="align-self-center mb-20" style="width: 30%;"
                            src="{{ asset('frontend/img/icon/card.png') }}" alt="Secure payment options"
                ...
                <div class="col-md-2 col-sm-6 col-6 mb-30">
                    <div class="d-flex static-media2 flex-column">
                        <img class="align-self-center mb-20" style="width: 30%;"
                            src="{{ asset('frontend/img/icon/cash-on-delivery.png') }}" alt="Cash on Delivery Available"
                            title="Cash on Delivery Available for Your Convenience">
                        <div class="media-body text-center">
                            <h4 class="title text-uppercase text-dark mb-25">
                                <a href="/cod-availability" title="Learn more about Cash on Delivery availability">COD
                                    Available</a>
                            </h4>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6 col-6 mb-30">
                    <div class="d-flex static-media2 flex-column">
                        <img class="align-self-center mb-20" style="width: 30%;"
                            src="{{ asset('frontend/img/icon/customer-service.png') }}" alt="Active customer support"
                            title="24/7 Active Customer Support">
                        <div class="media-body text-center">
                            <h4 class="title text-uppercase text-dark mb-25">
                                <a href="/customer-support" title="Contact our customer support for assistance">Active
                                    Support</a>
                            </h4>
                        </div>
                    </div>
