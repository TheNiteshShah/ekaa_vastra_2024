...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h2>Order Cancelled - Notification</h1>
        </div>
        ...
        <div class="order-details">
            ...
            <p><strong>Customer Name:</strong> {{ $orderData->address->first_name }} {{ $orderData->address->last_name }}</p>
            ...
            <p>Please take the necessary action and update the system accordingly.</p>
        </div>
        <!-- Order Summary Table -->
