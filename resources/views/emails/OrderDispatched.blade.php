...
<body>
    <div class="container">
        ...
        <div class="order-details">
            ...
            <p>Your order is on its way! We’ve dispatched your items, and they’ll reach you soon. Below are the details of your order.</p>
        ...
        <div style="text-align: center;">
            <a href="{{ $orderData->tracking_url }}" class="track-button">Track Your Order</a>
        </div>

        <!-- Footer Section -->
        <div class="footer">
            <p>Need help? <a href="mailto:info@ekaavastra.com">Contact Us</a></p>
            <p>Thank you for shopping with us! We hope your purchase brings you joy. 😊</p>
