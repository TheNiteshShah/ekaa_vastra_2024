...
<head>
    <title>Order Update - Order Rejected</title>
...
<body>
    <div class="container">
        ...
        <div class="order-details">
            ...
            <p>We regret to inform you that your recent order has been rejected. We apologize for any inconvenience caused. If you have questions or would like more information, please feel free to reach out to our support team.</p>
        ...
        <div style="text-align: center;">
            <a href="mailto:info@ekaavastra.com" class="contact-button">Contact Support</a>
        </div>

        <!-- Footer Section -->
        <div class="footer">
            <p>Need assistance? <a href="mailto:info@ekaavastra.com">Email Us</a></p>
            <p>Thank you for understanding. We apologize for the inconvenience. 🙏</p>
