...
<body>
    <div class="container">
        ...
        <div class="order-details">
            ...
            <p>We’re thrilled to inform you that your order has arrived. We hope you’re happy with your purchase! Below are the details of your order.</p>
        ...
        <!-- <div style="text-align: center;">
            <a href="https://www.ekaavastra.com/feedback/{{ $orderData->id }}" class="feedback-button">Leave Feedback</a>
        </div> -->

        <!-- Footer Section -->
        <div class="footer">
            <p>Need help? <a href="mailto:info@ekaavastra.com">Contact Us</a></p>
            <p>Thank you for choosing Ekaa Vastra. We hope you enjoy your purchase! 😊</p>
