...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h2>Thank you for shopping at Ekaa Vastra 🎉</h2>
        </div>

        <!-- Greeting and Order Info -->
        <div class="order-details">
            <p>Hi {{ $orderData->address->first_name }},</p>
            <p>Thank you for shopping with us! We’re excited to let you know that your order has been placed successfully.</p>
            ...
            @foreach($orderData->details as $item)
                <tr>
                    <td>
                        ...
                        <!-- <img src="https://www.ekaavastra.com/uploads/image/products/1728161432_6701a69830192.jpg" alt="{{ $item->product->name }}"> -->
